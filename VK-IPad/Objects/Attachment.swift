...
class Attachment {
    ...
    init(json: JSON) {
        ...
        if self.type == "wall" {
            ...
            record.id = json["wall"]["id"].intValue
            record.ownerID = json["wall"]["owner_id"].intValue
            record.fromID = json["wall"]["from_id"].intValue
            record.date = json["wall"]["date"].intValue
            record.text = json["wall"]["text"].stringValue
